...
namespace SmallCode.AspNetCore.HtmlAgilityPack
{
    /// <summary>
        ...
        public void WriteTo(TextWriter outText)
        {
            ...
            switch (_nodetype)
            {
                ...
                case HtmlNodeType.Document:
                    if (_ownerdocument.OptionOutputAsXml)
                    {
                        outText.Write("<?xml version=\"1.0\" encoding=\"" + _ownerdocument.GetOutEncoding().EncodingName +
                                      "\"?>");
            ...
            switch (_nodetype)
            {
                ...
                case HtmlNodeType.Document:
                    writer.WriteProcessingInstruction("xml",
                                                      ...
                                                      _ownerdocument.GetOutEncoding().EncodingName + "\"");
                    if (HasChildNodes)
                    {
